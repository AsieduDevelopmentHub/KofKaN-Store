...
export function WhatsAppFloat(props: WhatsAppFloatProps) {
  ...
  return (
    <a
      ...
      className="kofkan-tap fixed bottom-[calc(4.75rem+var(--safe-bottom))] right-3 z-[70] flex h-10 w-10 items-center justify-center rounded-full bg-[#25D366] text-white shadow-md ring-2 ring-white/90"
